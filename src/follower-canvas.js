import G_vmlCanvasManager from './excanvas';
...
/**
 * Canvas follower to display a site popup
 */
const MMFollower = function(MM) {
    MM.Follower = function(map, location, content) {
        ...
        this.dimensions = new MM.Point(100, 100);
        ...
        if (typeof G_vmlCanvasManager !== 'undefined')
            shadow = G_vmlCanvasManager.initElement(shadow);
        ...
        if (typeof G_vmlCanvasManager !== 'undefined')
            bubble = G_vmlCanvasManager.initElement(bubble);
    ...
    MM.Follower.prototype = {
        ...
        drawBubblePath: function(ctx) {
            ...
            ctx.quadraticCurveTo(
                this.dimensions.x,
                this.dimensions.y - 25,
                this.dimensions.x,
                this.dimensions.y - 35
            );
